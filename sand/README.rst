...
The `Obi-Wan Kenobi Series by Disney <https://disneyplusoriginals.disney.com/show/obi-wan-kenobi>`__
has a much better animation that inspired me to write my own.
...
.. literalinclude:: sand.py

.. |image0| image:: sand_animation_small.gif
